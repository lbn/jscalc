...
exports.Calculator = function Calculator(){}
...
var operators = exports.Calculator.operators = [
...
var functions = exports.Calculator.functions = [
...
var evaluateRPN_ = function evaluateRPN_(args) {
...
var structRPN = exports.structRPN = function structRPN(args) {
    var rpn = function rpn(lst,token) {
        ...
        if (op||fun) {
            ...
            return [u.first(lst,args).reverse().concat(token)].concat(u.last(lst,lst.length-args));
        } else {
...
exports.smartSplit = function(str) {
    return u.map(str.split(" "),function(t){if (isFinite(t)){return parseInt(t);}else{return t;}});
}
